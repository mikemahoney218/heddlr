...
# `heddlr`: Literate programming extensions for dynamic R Markdown documents
  ...
  <!-- badges: start -->
  [![Travis build status](https://travis-ci.com/mikemahoney218/heddlr.svg?branch=master)](https://travis-ci.com/mikemahoney218/heddlr)
  [![Codecov test coverage](https://codecov.io/gh/mikemahoney218/heddlr/branch/master/graph/badge.svg)](https://codecov.io/gh/mikemahoney218/heddlr?branch=master)
